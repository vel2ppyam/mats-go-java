...
public class TwitterFeignConfiguration {
    ...
    public RequestInterceptor requestInterceptor() {
        return requestTemplate -> {
            ...
            param.put("q", "nasa");
            param.put("result_type", "popular");
            requestTemplate.header("Authorization", getAuthorization(HttpMethod.POST.name(), "https://api.twitter.com/1.1/search/tweets.json", new HashMap<>()));
        };
    }
     ...
     * @return
     */
    public String getAuthorization(String httpMethod, String url, Map<String, String> requestParams) {
